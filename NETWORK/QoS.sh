...
queues:252=@1q \
queues:251=@2q -- \
--id=@1q create queue other-config:min-rate=6000000 other-config:max-rate=10000000 -- \
--id=@2q create queue other-config:min-rate=3000000 other-config:max-rate=5000000
echo ' ' 
...
queues:232=@1q \
queues:231=@2q -- \
--id=@1q create queue other-config:min-rate=60000000 other-config:max-rate=100000000 -- \
--id=@2q create queue other-config:min-rate=30000000 other-config:max-rate=50000000
echo ' '
